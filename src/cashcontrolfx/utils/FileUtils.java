...
import cashcontrolfx.model.Accounts;
import cashcontrolfx.model.Transaction;
import java.io.*;
...
public class FileUtils {
    ...
    public static List<Accounts> loadAccounts() throws FileNotFoundException, IOException{
    ...
    public static void saveAccounts(List<Accounts> listAccounts) throws FileNotFoundException, IOException{
        ...
        listAccounts.forEach( ( Accounts dataAccount ) -> {
    ...
    public static List<Transaction> loadTransactionsForAccount( Accounts account, String typeParams, String params ) throws FileNotFoundException, IOException{
